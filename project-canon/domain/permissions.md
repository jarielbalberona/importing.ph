...
- quote history is visible only through an already-authorized importer-owned request or the submitting forwarder company; no revision rollback mutation exists
- conversation attachment upload, finalization, cancellation, and download require current conversation participation; temporary files cannot be attached across users or conversations
